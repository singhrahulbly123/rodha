...
const faculty = [
  ...
  {
    name: "Abhishek Gupta",
    image: teamImagesArray[9],
    highlight: true,
    desc: `• Nearly two decades of teaching experience in Quant, DILR, and CR; mentored over a million students across offline and online formats\n• Cracked CAT several times (100%ile in DILR on multiple occasions), along with XAT, SNAP, NMAT, GRE, UPSC Prelims, and others\n• Renowned for an inspiring teaching presence, deep student connect, and ability to drive peak performance`
  }
];
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex gap-6 sm:justify-center sm:flex-wrap sm:overflow-visible overflow-x-auto snap-x snap-mandatory scroll-smooth px-1">
          {faculty.map((member, index) => (
            <div
              key={index}
              className="relative group min-w-[70%] sm:min-w-0 flex flex-col items-center transition-transform duration-300 hover:scale-105 snap-start"
            >
              {/* Image Container */}
              <div className="w-full h-auto overflow-hidden relative">
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 flex items-end justify-center transition-opacity">
                  <button
