            ...
            <div className="max-w-7xl mx-auto relative w-full flex flex-col md:flex-row items-center justify-between overflow-hidden p-3 sm:p-0">
                <div className=" z-10 max-w-6xl text-center md:text-left pb-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        <button className="relative overflow-hidden bg-white text-[#FD6A02] font-semibold px-6 py-3 rounded-full text-sm group transition-all duration-300 ease-in-out">
                        ...
                        <button className="relative overflow-hidden border border-white text-white font-semibold px-6 py-3 rounded-full text-sm group transition-all duration-300 ease-in-out">
                            ...
                            <style>{`
      .group:hover span.relative.z-10 {
        color: #FD6A02;
      }
    `}</style>
                        </button>
