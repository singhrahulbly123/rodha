...
const data = [
  { name: "Easy", Questions: 1, fill: "#FFBE18" },
  { name: "Medium", Questions: 1, fill: "#FF7300" },
  { name: "Tough", Questions: 2, fill: "#7C7C7C" },
];

export default function ScoreCard() {
  return (
    <div className="bg-[#ffffff] text-white py-5 sm:py-16 dark:bg-[#242424] py-5 dark:text-black">
      <div className="max-w-7xl mx-auto">


        <h2 className="text-center text-black dark:text-white text-3xl font-bold pb-10">
          Score <span className="text-orange-500">Card</span>
        </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-4 gap-4 p-4 sm:p-4">
          ...
          <div className="bg-[#4A4A4A] dark:bg-gray-200 p-4 rounded-xl">
            ...
            <p className="text-2xl font-bold">120 <span className="text-sm font-medium">Min</span></p>
          </div>
        </div>
          ...
          <div className="bg-white text-black dark:bg-[#fff] dark:text-black p-4 rounded-xl shadow border border-gray-200">
            ...
            <div className="flex justify-around text-sm pt-2">
              <div className="flex items-center space-x-1">
                <div className="w-5 h-3 bg-[#FFBE18] rounded-0"></div>
                <span>Easy</span>
              </div>
              <div className="flex items-center space-x-1">
                <div className="w-5 h-3 bg-[#FF7300] rounded-0"></div>
                <span>Medium</span>
              </div>
              <div className="flex items-center space-x-1">
                <div className="w-5 h-3 bg-[#7C7C7C] rounded-0"></div>
                <span>Tough</span>
              </div>
            </div>
          </div>
