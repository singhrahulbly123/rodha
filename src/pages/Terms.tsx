          ...
          <div className="bg-zinc-50 dark:bg-[#1A1A1A] p-6 sm:p-10 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700">
            <div className="space-y-8 text-[15px] sm:text-[17px] leading-7 text-gray-800 dark:text-gray-200">
              <section>
                ...
                <p>
                  These terms and conditions outline the rules and regulations for the use of Rodha's website, located at<a href="https://mocks.rodha.co.in" className="text-blue-600 underline ml-1" target="_blank" rel="noopener noreferrer">https://mocks.rodha.co.in</a>
                  By accessing this website we assume you accept these terms and conditions. Do not continue to use <a href="https://mocks.rodha.co.in" className="text-blue-600 underline ml-1" target="_blank" rel="noopener noreferrer">https://mocks.rodha.co.in</a> if you do not agree to take all of the terms and conditions stated on this page.
              ...
              <section>
                ...
                <p>
                  We employ the use of cookies. By accessing <a href="https://mocks.rodha.co.in" className="text-blue-600 underline ml-1" target="_blank" rel="noopener noreferrer">https://mocks.rodha.co.in</a>, you agree to use cookies in agreement with Rodha's Privacy Policy.
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>Redistribute content from  <a href="https://mocks.rodha.co.in" className="text-blue-600 underline ml-1" target="_blank" rel="noopener noreferrer">https://mocks.rodha.co.in</a></li>
                </ul>
                ...
                <p>You hereby grant Rodha a non-exclusive licence to use, reproduce, edit and authorise others to use, reproduce and edit any of your Comments in any and all forms, formats or media. </p>
              </section>
              ...
              <section>
                ...
                <p>No use of Rodha's logo or other artwork will be allowed for linking absent a trademark licence agreement. </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-2">
                  Links must not be misleading or imply endorsement.
                </p>
              </section>
              ...
              <section>
                ...
                <ul>
                  <ol>are subject to the preceding paragraph; and</ol>
                  <ol>govern all liabilities arising under the disclaimer, including liabilities arising in contract, in
tort and for breach of statutory duty.</ol>
                </ul>
